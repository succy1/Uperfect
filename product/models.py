...
class Product(models.Model):
    ...
    is_natural_organic = models.CharField(max_length=100, null=True, blank=True)
    has_fragrance = models.BooleanField(default=False)
    has_oil = models.BooleanField(default=False)
    product_url = models.URLField(null=True, blank=True)
    avg_rating = models.FloatField(default=4)
